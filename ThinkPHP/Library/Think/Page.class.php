...
class Page{
    ...
    private $config  = array(
        ...
        'prev'   => '<span class="uk-icon-angle-double-left"><<</span>',
        'next'   => '<span class="uk-icon-angle-double-right">>></span>',
        'first'  => '1...',
        'last'   => '...%TOTAL_PAGE%',
    ...
    public function show() {
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page > 0 && $this->totalPages != 1){
                    $link_page .= '<li class="uk-active active"><span class="current">' . $page . '</span></li>';
                }
            }
        }
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        return "<ul class='uk-pagination pagination pagination-sm no-margin pull-right'>{$page_str}</ul>";
    }
}
